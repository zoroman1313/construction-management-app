...
import TeamTab from '@/modules/accounting/TeamTab';
import ToolsTab from '@/modules/accounting/ToolsTab';
import MaterialsTab from '@/modules/accounting/MaterialsTab';
import TransactionsTab from '@/modules/accounting/TransactionsTab';
